...
#include "Stg_Meta_Signal_Switch.mqh"

// Defines.
#define ea_name "Strategy Meta Signal Switch"
#define ea_version "2.000"
#define ea_desc "Meta Signal Switch strategy to switch strategies based on signals from another strategy."
#define ea_link "https://github.com/EA31337/Strategy-Meta_Signal_Switch"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_Meta_Signal_Switch>(Active_Tfs);
